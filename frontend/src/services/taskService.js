...
import {set, setPriorities, setRegularities, setSelectedTask, setStatuses, setAllTask} from "../slices/taskSlice";
...
const createTask = (category_id, task, dispatch) => {
    ...
    return axios.post(API_URL+`?categoryId=${category_id}`, task, {headers: authHeader()}).then(
        () => {
